...
public class ExercicesCoursApplication {
	...
	public static void main(String[] args) {
		...
		Formation fmInter = new FormationInter(2);
		fmInter.setCode("JVA");
		...
		Formation fmInter1 = new FormationInter(2);
		fmInter1.setCode("XXX");
		fmInter1.setPrix(2050);
		formationsRepository.save(fmInter1);
